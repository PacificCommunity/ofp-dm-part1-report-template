...
if (is_applicable("2009-06")) {
  ...
  if (!file.exists(trans1_file) && !file.exists(trans2_file)) {
    cat(no_data_msg("2009-06", context = "transhipment quantities"))
  }
...
if (is_applicable("2009-06")) {
  ...
  if (file.exists(trans4_file)) {
    knitr::include_graphics(trans4_file)
  }
  
  if (!file.exists(trans3_file) && !file.exists(trans4_file)) {
    cat(no_data_msg("2009-06", context = "transhipment quantities"))
  }
