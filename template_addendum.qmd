...
if (nrow(a1) > 0) {
  ...
  msg=paste0("No fishing for swordfish was reported in ",params$max_year," or not applicable.")
}
```
`r msg`
...
if (nrow(a2) > 0) {
  ...
  msg = "No observer coverage data available or not applicable."
}
```
`r msg`
...
if (nrow(a5) > 0) {
  ...
  msg = paste0("No cetacean encirclements by purse seine nets were reported in ",params$max_year," or not applicable.")
}
```
`r msg`
...
if (nrow(a6) > 0) {
  ...
  fontsize(size = 8, part = "all")
     ...
     msg=paste0("There was no reported longline activity in ",params$max_year," for the region or not applicable.")
    }
...
if(exists(df_name) && is.data.frame(get(df_name))){
  ...
  msg=paste0("There was no reported longline activity in ",params$max_year," for area south of 30S or not applicable.")
}
```
`r msg`
...
if(exists(df_name) && is.data.frame(get(df_name))){
  ...
  msg=paste0("There was no reported longline activity in ",params$max_year," for area between 30S and 25S or not applicable.")
}
```
`r msg`
...
if(exists(df_name) && is.data.frame(get(df_name))){
  ...
  msg=paste0("There was no reported longline activity in ",params$max_year," for area between 25S and 23N or not applicable.")
}
```
`r msg`
...
if(exists(df_name) && is.data.frame(get(df_name))){
  ...
  msg=paste0("There was no reported longline activity in ",params$max_year," for area north of 23N or not applicable.")
}
```
`r msg`
...
if (nrow(a7.south) > 0) {
  ...
  msg=paste0("No data were reported in ",params$max_year," for area south of 30S or not applicable.")
}
```
`r msg`
...
if (nrow(a7.mids) > 0) {
  ...
  msg= paste0("No data were reported in ",params$max_year," for area between 30S and 25S or not applicable.")
}
```
`r msg`
...
if (nrow(a7.midn) > 0) {
  ...
  msg=paste0("No data were reported in ",params$max_year," for the area between 25S and south of 23N or not applicable.")
}
```
`r msg`
...
if (nrow(a7.north) > 0) {
  ...
  msg = paste0("No data were reported in ",params$max_year," for area north of 23N or not applicable.")
}
```
`r msg`
...
if (nrow(a8) > 0) {
  ...
  msg = "No seabird interaction data (Table z) available or not applicable."
}
```
`r msg`
...
if (nrow(a9) > 0) {
  ...
  msg = paste0("No vessels fished for striped marlin in ",params$max_year," or not applicable.")
}
```
`r msg`
...
if (nrow(a11) > 0) {
  ...
  msg = paste0("There was no fishing effort or catch of albacore north of the equator in ",params$max_year," or not applicable.")
}
```
`r msg`
...
if (nrow(a12) > 0) {
  ...
  msg = paste0("There was no fishing effort nor catch of North Pacific swordfish in ",params$max_year," or not applicable.")
}
```
`r msg`
